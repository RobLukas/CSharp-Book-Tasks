...
namespace Rozdz_6_zad_2
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            workers[1] = new Worker(new string[] { "Pięlegnacja jaj", "Nauczanie pszczółek" });
            workers[2] = new Worker(new string[] { "Utrzymanie ula", "Patrol z żądłami" });
            workers[3] = new Worker(new string[] { "Zbieranie nektaru", "Wytwarzanie miodu", "Pięlegnacja jaj", "Nauczanie pszczółek", "Utrzymanie ula", "Patrol z żądłami" });
